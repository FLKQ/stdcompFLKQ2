...
import {Nav, NavbarContainer, NavbarLogo, NavbarIcon, NavbarMenu, NavbarItem, NavbarLinks, MobileIcon, NavbarButtonItem, NavbarButtonLink } from './Navbar.elements'
                        ...
                        <NavbarMenu onClick={handleClick} click={click}>
                            ...
                            {button ? (
                                <NavbarButtonLink to='/sign-up'>
                                    <Button primary colorized>SIGN UP</Button>
                                </NavbarButtonLink>
                                ) : (
                                <NavbarButtonLink to='/sign-up'>
